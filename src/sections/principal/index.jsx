...
export default function Principal() {
    ...
    return (
        <div id="principal">
            <div id="hero" style={heroBackground}>
                <h1>Diego Cardona</h1>
                <h2>Front-end developer <img src="/static/icons/colombia-flag.svg" /></h2>
            </div>
            
            <div id="about-me">
                <p>I am a 17.6-year-old teenager, almost of being 18 years old (of course). In general, I consider myself someone with a lot of potential to do whatever I want. I am a born leader and I enjoy learning and I am very imaginative, so much so that sometimes I go too far from "reality".</p>
                ...
                <p>3 years ago, in 2017 I received a Front-end Architect certificate at <a href="https://www.platzi.com" target="_blank">https://www.platzi.com</a> and this is the only certificate I have because I have developed myself by watching other people's code, programming and learning on my own.</p>
